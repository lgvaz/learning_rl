...
class ParallelEnvs:
    ...
    '''
    def __init__(self, env_name, num_actions, policy_net, sess, render):
    ...
    def run(self, batch_size):
        ...
        self.q.join()
        return self.shared_experience, self.ep_lengths
    ...
    def _run_episode(self, env):
        ...
        for i_step in itertools.count():
            ...
            # Break loop if episode is done or is going from to long
            if done:
                # Calculate returns
